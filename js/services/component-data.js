...
const ComponentData = {
  ...
  <div class="nav-brand">
    ...
    <span class="brand-name">My Website</span>
                            ...
                            explanation: 'Let\'s break down each line:\nGÇó <nav class="navbar"> - Creates a navigation container. The class="navbar" gives it a name so we can style it later.\nGÇó <div class="nav-brand"> - A box to hold our logo and website name together.\nGÇó <img src="img/webforge-icon.png" alt="Logo" class="nav-logo"> - Shows an image. "src" tells where to find the image file. "alt" describes it for people who can\'t see it (important for accessibility!).\nGÇó <span class="brand-name"> - Holds text. Unlike <div>, <span> doesn\'t start a new line.\nGÇó </nav> - Closes the navigation container.\n\nNote: You can replace "img/webforge-icon.png" with your own logo image path!',
                            validation: {
                                required: [
                                    {
                                        type: 'tag',
  ...
  <li><a href="#contact" class="nav-link">Contact</a></li>
                            ...
                            explanation: 'Here\'s what each part does:\nGÇó <ul class="nav-menu"> - Creates an unordered list (bullets by default, but we\'ll remove them with CSS).\nGÇó <li> - List item. Each one is a menu button.\nGÇó <a href="#home"> - A link! "href" tells where to go. The # means it\'s a link to a section on the same page.\nGÇó class="nav-link" - Names the link so we can style all links the same way.\nGÇó Home, About, etc. - The text people see and click on.',
                            validation: {
                                required: [
                                    {
                                        type: 'tag',
  ...
  padding: 1rem 2rem;
                            ...
                            explanation: 'Let\'s understand each CSS property:\nGÇó background-color: #2c3e50 - Paints the navbar dark blue-gray. #2c3e50 is a color code (hex code). You can use any color you like!\nGÇó padding: 1rem 2rem - Adds space inside the navbar. 1rem top/bottom, 2rem left/right. "rem" is a size unit that scales nicely.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  align-items: center;
                            ...
                            explanation: 'Understanding Flexbox properties:\nGÇó display: flex - Turns on Flexbox! This makes items line up in a row and gives us control over how they\'re arranged.\nGÇó justify-content: space-between - Pushes items apart. Logo goes left, menu goes right, with space between them.\nGÇó align-items: center - Lines everything up in the middle vertically, so nothing looks crooked or misaligned.',
                            validation: {
                                required: [
                                    {
                                        type: 'property',
  ...
  gap: 0.75rem;
                            ...
                            explanation: 'Understanding .nav-brand:\nGÇó display: flex - Makes the logo and text sit side-by-side instead of stacking.\nGÇó align-items: center - Lines them up in the middle vertically so they\'re not misaligned.\nGÇó gap: 0.75rem - Adds space between logo and text. Like giving them breathing room!',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  border-radius: 8px;
                            ...
                            explanation: 'Understanding .nav-logo:\nGÇó width: 40px - Makes the logo exactly 40 pixels wide.\nGÇó height: 40px - Makes the logo exactly 40 pixels tall. Same as width makes it a perfect square!\nGÇó border-radius: 8px - Rounds the corners. Higher numbers = rounder corners. Try 50% for a circle!',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  font-weight: 600;
                            ...
                            explanation: 'Understanding .brand-name:\nGÇó color: white - Makes the text white so it shows up clearly on the dark background.\nGÇó font-size: 1.5rem - Makes the text bigger (1.5 times the normal size). This makes it stand out!\nGÇó font-weight: 600 - Makes it semi-bold. 400 is normal, 700 is very bold.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  padding: 0;
                            ...
                            explanation: 'Understanding .nav-menu:\nGÇó display: flex - Lines up menu items in a row instead of stacking them.\nGÇó list-style: none - Removes the bullet points that lists normally have.\nGÇó gap: 2rem - Adds space between each menu item automatically.\nGÇó margin: 0 and padding: 0 - Removes default spacing that browsers add to lists. This gives us full control!',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  border-radius: 6px;
                            ...
                            explanation: 'Understanding .nav-link:\nGÇó color: white - Makes link text white so it shows up on the dark navbar.\nGÇó text-decoration: none - Removes the underline that links normally have.\nGÇó padding: 0.5rem 1rem - Adds space inside each link to make it bigger and easier to click.\nGÇó border-radius: 6px - Slightly rounds the corners for a modern look.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
...
.nav-link:hover {
  background-color: rgba(255, 255, 255, 0.1);
                            ...
                            explanation: 'Understanding hover effects:\nGÇó transition: background-color 0.3s - Makes color changes smooth over 0.3 seconds instead of instant. This creates a nice animation!\nGÇó .nav-link:hover - This means "when mouse is over a .nav-link"\nGÇó rgba(255, 255, 255, 0.1) - White color with 0.1 opacity (10% visible, 90% see-through). Creates a subtle highlight when you hover!',
                            validation: {
                                required: [
                                    {
                                        type: 'property',
  ...
  <a href="#services" class="nav-link">Services Gû+</a>
  <ul class="dropdown-menu">
    ...
    <li><a href="#seo" class="dropdown-link">SEO</a></li>
                            ...
                            codeFile: 'index.html',
                            tip: 'A dropdown is a menu inside a menu! We\'re putting a <ul> inside a <li>. The Gû+ symbol shows users there\'s a menu!',
                            explanation: 'Here\'s the structure:\nGÇó <li class="dropdown"> - The main menu item. The "dropdown" class tells CSS this one has a submenu.\nGÇó <a href="#services" class="nav-link">Services Gû+</a> - The main link you see. The Gû+ is a down arrow symbol that hints there\'s a dropdown!\nGÇó <ul class="dropdown-menu"> - A new list INSIDE the list item! This is the hidden menu.\nGÇó Three <li> items inside - These are the dropdown options (Web Design, App Development, SEO).\nGÇó class="dropdown-link" - Styles these links differently from the main menu links.\n\nThink of it like a folder with files inside. The folder is "Services" and the files are the three options!',
                            validation: {
                                required: [
                                    {
                                        type: 'class',
...
.dropdown-menu {
  ...
  left: 0;
                            ...
                            explanation: 'Understanding positioning:\nGÇó .dropdown { position: relative; } - Makes this the "anchor point" for the dropdown menu. The menu will position itself relative to this.\nGÇó .dropdown-menu { position: absolute; } - Takes it out of normal flow. It floats above other content!\nGÇó top: 100% - Positions it right below the Services link (100% = full height of parent).\nGÇó left: 0 - Aligns it with the left edge of Services.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  min-width: 200px;
                            ...
                            explanation: 'Understanding dropdown styling:\nGÇó background-color: #34495e - Slightly lighter than the navbar so it stands out.\nGÇó list-style: none - Removes bullet points from the dropdown list.\nGÇó padding: 0.5rem 0 - Adds space at top and bottom.\nGÇó margin: 0 - Removes default spacing.\nGÇó border-radius: 6px - Rounds the corners to match our design.\nGÇó min-width: 200px - Makes sure it\'s at least 200px wide, even if text is short.',
                            validation: {
                                required: [
                                    {
                                        type: 'property',
...
.dropdown:hover .dropdown-menu {
  display: block;
                            ...
                            explanation: 'Understanding show/hide:\nGÇó display: none - HIDES the menu by default! It\'s completely invisible and takes up no space.\nGÇó .dropdown:hover .dropdown-menu - This means "When hovering over .dropdown, find .dropdown-menu inside it"\nGÇó display: block - SHOWS the menu! Changes from none to block when you hover over Services.',
                            validation: {
                                required: [
                                    {
                                        type: 'property',
...
.dropdown-link:hover {
  background-color: rgba(255, 255, 255, 0.1);
                            ...
                            explanation: 'Understanding dropdown links:\nGÇó color: white - Makes text white.\nGÇó text-decoration: none - Removes underlines.\nGÇó padding: 0.75rem 1.5rem - More padding than main links for better spacing in the dropdown.\nGÇó display: block - Makes each link take up the full width, easier to click.\nGÇó .dropdown-link:hover - Adds a subtle highlight when you hover over dropdown items, just like the main menu!',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  <div class="hero-image">
    <img src="img/workshop-hero-image.png" alt="Student coding">
                            ...
                            explanation: 'Breaking it down:\nGÇó <section class="hero"> - Creates a section for our hero area.\nGÇó <div class="hero-content"> - Left side container for text and button.\nGÇó <h1> - The main heading. This is the biggest, most important text!\nGÇó <p class="hero-subtitle"> - A subtitle that explains more.\nGÇó <button class="hero-cta"> - A call-to-action button.\nGÇó <div class="hero-image"> - Right side container for the image.\nGÇó <img> - The hero image that makes it look awesome!',
                            validation: {
                                required: [
                                    {
                                        type: 'tag',
  ...
  padding: 2rem;
                            ...
                            explanation: 'Understanding the properties:\nGÇó min-height: 100vh - Makes the hero at least as tall as the screen. "vh" stands for "viewport height"!\nGÇó padding: 2rem - Adds space inside the hero so content doesn\'t touch the edges.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  gap: 3rem;
                            ...
                            explanation: 'Flexbox layout:\nGÇó display: flex - Turns on Flexbox mode! This makes items line up in a row.\nGÇó align-items: center - Centers content vertically (up and down).\nGÇó justify-content: space-between - Pushes items apart with space between them.\nGÇó gap: 3rem - Adds space between the text and image sections.',
                            validation: {
                                required: [
                                    {
                                        type: 'property',
  ...
  color: white;
                            ...
                            explanation: 'Understanding the background:\nGÇó background: #667eea - A nice purple-blue color. #667eea is a hex color code!\nGÇó color: white - Makes all text white so it shows up clearly on the dark background.\nGÇó You can change #667eea to any color you want - try #3498db for blue, #e74c3c for red, or #2ecc71 for green!',
                            validation: {
                                required: [
                                    {
                                        type: 'property',
...
.hero-image img {
  ...
  border-radius: 15px;
                            ...
                            explanation: 'Section styling:\nGÇó flex: 1 - Makes each section take up equal space.\nGÇó max-width: 500px - Limits how wide they can get.\nGÇó .hero-image img - Targets the image inside hero-image.\nGÇó width: 100% - Makes image fill its container.\nGÇó height: auto - Keeps the image proportions correct.\nGÇó border-radius: 15px - Rounds the image corners for a modern look!',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  line-height: 1.2;
                            ...
                            explanation: 'Title styling:\nGÇó font-size: 3rem - Makes it really big! "rem" is a flexible size unit.\nGÇó font-weight: 700 - Makes it bold. 400 is normal, 700 is bold.\nGÇó margin-bottom: 1rem - Adds space below the title.\nGÇó line-height: 1.2 - Controls spacing between lines if the title wraps.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  line-height: 1.5;
                            ...
                            explanation: 'Subtitle styling:\nGÇó font-size: 1.25rem - Bigger than normal text, but smaller than the title.\nGÇó margin-bottom: 2rem - Adds space below before the button.\nGÇó opacity: 0.9 - Makes it 90% visible (10% transparent). Creates a softer look!\nGÇó line-height: 1.5 - More space between lines makes it easier to read.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  cursor: pointer;
                            ...
                            explanation: 'Button styling:\nGÇó background: #4CAF50 - Nice green color.\nGÇó color: white - White text on green background.\nGÇó border: none - Removes the default button border.\nGÇó padding: 1rem 2rem - Makes the button bigger and easier to click.\nGÇó font-size: 1.1rem - Slightly bigger text.\nGÇó font-weight: 600 - Semi-bold text.\nGÇó border-radius: 5px - Rounds the corners.\nGÇó cursor: pointer - Shows a hand cursor on hover.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
...
.hero-cta:hover {
  ...
  box-shadow: 0 6px 20px rgba(76, 175, 80, 0.4);
                            ...
                            explanation: 'Hover effects:\nGÇó transition: all 0.3s ease - Makes changes smooth over 0.3 seconds.\nGÇó box-shadow - Adds a shadow under the button for depth.\nGÇó :hover - Special selector that applies when mouse is over the button.\nGÇó background: #45a049 - Slightly darker green on hover.\nGÇó transform: translateY(-2px) - Moves button up 2 pixels (negative = up!).\nGÇó Bigger shadow on hover makes it look like it\'s lifting up!',
                            validation: {
                                required: [
                                    {
                                        type: 'property',
  ...
  <div class="card-content">
    ...
    <button class="card-button">Learn More</button>
                            ...
                            explanation: 'Card structure:\nGÇó <div class="card"> - The main container for everything.\nGÇó <img class="card-image"> - An image at the top of the card.\nGÇó <div class="card-content"> - Holds the text and button.\nGÇó <h3 class="card-title"> - The card\'s heading.\nGÇó <p class="card-description"> - Description text.\nGÇó <button class="card-button"> - Action button at the bottom.',
                            validation: {
                                required: [
                                    {
                                        type: 'class',
  ...
  overflow: hidden;
                            ...
                            explanation: 'Card container styling:\nGÇó max-width: 320px - Keeps the card from getting too wide.\nGÇó background: white - Clean white background.\nGÇó border-radius: 16px - Nicely rounded corners for a modern look.\nGÇó overflow: hidden - Clips anything that goes outside the rounded corners (like the image).',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  transition: all 0.3s ease;
                            ...
                            explanation: 'Shadow and transition:\nGÇó box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08) - Creates a soft, modern shadow.\n  - 0 = no horizontal offset\n  - 10px = 10 pixels down\n  - 30px = blur amount (more blur = softer shadow)\n  - rgba(0, 0, 0, 0.08) = black at 8% opacity\nGÇó transition: all 0.3s ease - Makes changes smooth (we\'ll use this for hover effects!).',
                            validation: {
                                required: [
                                    {
                                        type: 'property',
  ...
  display: block;
                            ...
                            explanation: 'Image styling:\nGÇó width: 100% - Makes image as wide as the card.\nGÇó height: 200px - Fixed height of 200 pixels.\nGÇó object-fit: cover - Crops the image to fill the space while keeping its proportions. No stretching!\nGÇó display: block - Removes tiny gap under the image.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
  ...
  padding: 1.75rem;
                            ...
                            explanation: 'Content padding:\nGÇó padding: 1.75rem - Adds space on all sides inside the content area.\nGÇó This keeps text away from the edges, making it easier to read.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
...
.card-description {
  ...
  font-size: 0.95rem;
                            ...
                            explanation: 'Text styling:\n\n.card-title:\nGÇó font-size: 1.35rem - Slightly bigger for emphasis.\nGÇó font-weight: 700 - Bold for impact.\nGÇó color: #1a1a1a - Almost black, modern look.\nGÇó letter-spacing: -0.02em - Tighter spacing for a modern feel.\n\n.card-description:\nGÇó color: #6b7280 - Soft gray for body text.\nGÇó line-height: 1.6 - More space between lines.\nGÇó font-size: 0.95rem - Slightly smaller than default.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
...
.card:hover {
  ...
  box-shadow: 0 20px 40px rgba(0, 0, 0, 0.12);
                            ...
                            explanation: 'Button and hover effects:\n\n.card-button:\nGÇó background: #667eea - Beautiful purple color.\nGÇó border-radius: 10px - Rounded button corners.\nGÇó width: 100% - Button fills the full width.\n\n.card-button:hover:\nGÇó background: #5568d3 - Darker purple on hover.\nGÇó transform: translateY(-2px) - Button lifts slightly.\nGÇó box-shadow - Glowing shadow effect.\n\n.card:hover:\nGÇó transform: translateY(-8px) - Lifts the card up 8 pixels!\nGÇó box-shadow: 0 20px 40px - Bigger, softer shadow makes it look like it\'s floating higher.',
                            validation: {
                                required: [
                                    {
                                        type: 'selector',
...
.stat-item:nth-child(4) .stat-number {
            ...
            // Quote Highlight Block
            {
                ...
                preview: `<div class="component-preview-placeholder">
                    <div style="background: #f8fafc; padding: 2rem; border-radius: 16px; border-left: 4px solid #3b82f6; max-width: 300px; margin: 1rem auto; position: relative;">
                        ...
                        <div style="font-size: 0.85rem; font-weight: 600; color: #6b7280;">GÇö Elder Name</div>
                    </div>
                </div>`,
                workshop: {
  ...
  <cite class="quote-author">GÇö Elder Name</cite>
</blockquote>`,
                            codeFile: 'index.html',
                ...
                preview: `<div class="component-preview-placeholder">
                    <div style="padding: 1.5rem; max-width: 300px; margin: 0 auto;">
                        <div style="border-left: 3px solid #3b82f6; padding-left: 1.5rem; position: relative; margin-bottom: 1.5rem;">
                            ...
                            <div style="font-size: 0.95rem; font-weight: 700; color: #1a1a1a; margin-bottom: 0.4rem; cursor: pointer;">Major Event Gû+</div>
...
timelineTitles.forEach(title => {
  title.addEventListener('click', () => {
    ...
    if (details.classList.contains('hidden')) {
      title.textContent = title.textContent.replace('Gû¦', 'Gû+');
    } else {
      title.textContent = title.textContent.replace('Gû+', 'Gû¦');
    }
  });
